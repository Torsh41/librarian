...
(2, 'Английский для химиков-технологов', 'Т.И. Кузнецова Е.В. Воловикова И.А. Кузнецов', '', 
    3, 262, 'Учебник по английскому для химиков-технологов.', 2, 0, '/files/resources/english_for_chemical_engineers.pdf', 2, '/files/icons/book_icon.jpg'),
(3, 'Задачи по общей химии', 'А.Ф. Воробьева', '', 
    3, 248, 'Задачник по общей химии.', 2, 0, '/files/resources/general_chemistry_problems.pdf', 3, '/files/icons/book_icon.jpg'),
(4, 'Задачи и упражнения по органической химии', 'В.М. Потапов С.Н. Татаринчик А.В. Аверина', '', 
    3, 184, 'Задачник по органической химии.', 2, 0, '/files/resources/organic_chemistry_problems_and_exercises.pdf', 3, '/files/icons/book_icon.jpg'),
(5, 'Общие методы работы в лаборатории органической химии', 'РХТУ им. Д.И. Менделеева', '', 
    2, 150, 'Учебник по общим методам работы в лаборатории органической химии.', 2, 0, '/files/resources/general_methods_in_organic_chemistry_lab.pdf', 2, '/files/icons/book_icon.jpg'),
(6, 'Органическая химия', 'РХТУ им. Д.И. Менделеева', '', 
    2, 150, 'Учебник по органической химии.', 2, 0, '/files/resources/organic_chemistry.pdf', 2, '/files/icons/book_icon.jpg'),
(7, 'Аналитическая химия. Химические методы анализа', 'С.Л. Рогатинская', '', 
    2, 150, 'Задачник по аналитической химии.', 2, 0, '/files/resources/analytical_chemistry_chemical_methods.pdf', 3, '/files/icons/book_icon.jpg'),
(8, 'Дифференциальное и интегральное исчисление функции многих переменных', 'РХТУ им. Д.И. Менделеева', '', 
    2, 150, 'Учебник по дифференциальному и интегральному исчислению функции многих переменных.', 1, 0, '/files/resources/multivariable_calculus.pdf', 3, '/files/icons/book_icon.jpg'),
(9, 'Основы языка программирования Си', 'РХТУ им. Д.И. Менделеева', '', 
    2, 150, 'Учебник по основам языка программирования Си.', 6, 0, '/files/resources/fundamentals_of_c_programming.pdf', 2, '/files/icons/book_icon.jpg'),
(10, 'Сборник расчетных работ по высшей математике ТОМ 2', 'РХТУ им. Д.И. Менделеева', '', 
    1, 150, 'Обыкновенные дифференциальный уравнения и системы. Ряды. Уравнения в частных производных.', 1, 0, '/files/resources/higher_math_calculation_works_volume_2.pdf', 3, '/files/icons/book_icon.jpg'),
(11, 'C++. Элементарное программирование', 'Ю.В. Сбоева', '', 
    1, 150, 'Учебник по элементарному программированию на C++.', 6, 0, '/files/resources/cpp_elementary_programming.pdf', 2, '/files/icons/book_icon.jpg'),
(12, 'Сборник задач по высшей математике', 'К.Н. Лунгу', '', 
    1, 150, 'Линейная алгебра. Аналитическая геометрия. Основы математического анализа. Комплексные числа.', 1, 0, '/files/resources/advanced_math_problem_set.pdf', 3, '/files/icons/book_icon.jpg'),
(13, 'Введение в нанотехнологию', 'Н. Кобаяси', '', 
    1, 150, 'Учебник по введению в нанотехнологии.', 17, 0, '/files/resources/introduction_to_nanotechnology.pdf', 2, '/files/icons/book_icon.jpg'),
(14, 'Титриметрические методы анализа', 'Н.М. Дубова', '', 
    1, 150, 'Учебник по титриметрическим методам анализа.', 2, 0, '/files/resources/titrimetric_analysis_methods.pdf', 2, '/files/icons/book_icon.jpg'),
(15, 'Сборник задач по теории вероятностей', 'Х.М. Андрухаев', '', 
    1, 150, 'Сборник задач по теории вероятностей.', 30, 0, '/files/resources/probability_theory_problem_set.pdf', 3, '/files/icons/book_icon.jpg'),
(16, 'Задачи и упражнения по математическому анализу', 'И.А. Виноградова С.Н. Олехник В.А. Садовничий', '', 
    1, 150, 'Задачник по математическому анализу.', 1, 0, '/files/resources/math_analysis_problems_and_exercises.pdf', 3, '/files/icons/book_icon.jpg');
